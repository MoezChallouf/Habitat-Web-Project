    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card">
            <div class="table-responsive text-nowrap">
                ...
                @endif
                <table id="subcategory" class="Subcategory table-striped" style="width:100%">
                    <thead class="table-light">
                    <tr>
                        <th class="text-center" data-priority="1">Id</th>
                        <th class="text-center" data-priority="2">Sub Category Name</th>
                        <th class="text-center" data-priority="3">Category</th>
                        <th class="text-center" data-priority="4">Product</th>
