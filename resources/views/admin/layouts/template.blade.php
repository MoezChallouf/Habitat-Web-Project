    ...
    <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
              ...
              <span class="app-brand-logo demo">
                ...
                >
                  ...
                  <g id="g-app-brand" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <span class="app-brand-text demo menu-text fw-bolder ms-2">Hyper Optima</span>
                </a>
            ...
            <ul class="menu-inner py-1">
                ...
                <!-- Cards -->
                <li class="menu-item ">
                    <a href="{{route('addpartner')}}" class="menu-link">
                        <i class="menu-icon tf-icons bx bx-home-circle"></i>
                        <div data-i18n="Analytics">Add Partner</div>
                    </a>
                </li>
                <li class="menu-item ">
                    <a href="{{route('allpartners')}}" class="menu-link">
                        <i class="menu-icon tf-icons bx bx-home-circle"></i>
                        <div data-i18n="Analytics">All Partners</div>
                    </a>
                </li>
                <li class="menu-header small text-uppercase"><span class="menu-header-text">References</span></li>
                <!-- Cards -->
                <li class="menu-item ">
                    <a href="{{route('addreference')}}" class="menu-link">
                        <i class="menu-icon tf-icons bx bx-home-circle"></i>
                        <div data-i18n="Analytics">Add Reference</div>
                    </a>
                </li>
                <li class="menu-item ">
                    <a href="{{route('allreferences')}}" class="menu-link">
                        <i class="menu-icon tf-icons bx bx-home-circle"></i>
                        <div data-i18n="Analytics">All References</div>
                    </a>
                </li>
            </ul>
        </aside>
